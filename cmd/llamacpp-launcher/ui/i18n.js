...
const I18N = {
  en: {
    ...
    l_server_settings: "Server settings",
    l_app_settings: "Application",
    l_model_dir: "Model directory",
    l_llama_server: "llama-server binary",
    btn_apply: "Apply",
    model_dir_empty: "Model directory is not set",
    model_dir_changed: "Model directory changed",
    llama_server_empty: "llama-server path is not set",
    llama_server_changed: "llama-server path saved",
    l_language: "Language",
    saved: "Saved",
    language_saved: "Language saved",
    err_service_root: "This action requires root privileges (systemctl). Relaunch the application as root (e.g. with sudo) to start, stop, or restart the service.",
    h_flags: "Flags",
  ...
  ru: {
    ...
    l_server_settings: "Настройки сервера",
    l_app_settings: "Приложение",
    l_model_dir: "Папка моделей",
    l_llama_server: "Исполняемый файл llama-server",
    btn_apply: "Применить",
    model_dir_empty: "Папка моделей не выбрана",
    model_dir_changed: "Папка моделей изменена",
    llama_server_empty: "Путь к llama-server не введён",
    llama_server_changed: "Путь к llama-server сохранён",
    l_language: "Язык интерфейса",
    saved: "Сохранено",
    language_saved: "Язык сохранён",
    err_service_root: "Это действие требует прав root (systemctl). Перезапустите приложение от root (например, через sudo), чтобы запускать, останавливать и перезапускать службу.",
    h_flags: "Флаги",
